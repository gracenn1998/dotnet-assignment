<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditEvent.aspx.cs" Inherits="FinalProject.Timetable.EditEvent" Culture = "en-GB"%>
...
<body>
    <form id="form1" runat="server">
        <div class="card p-3 mt-2 mb-2 mx-auto" style="width: 27rem;">
            <h5 class="card-title text-center bg-dark text-light w-100">Edit Event</h5>
            ...
            <div class="form-group row">
             ...
             <div class="row w-100 mx-auto">
                 <asp:LinkButton ID="ButtonDelete" runat="server" OnClick="ButtonDelete_Click" CssClass="text-danger" Text="❌Delete Event" />
